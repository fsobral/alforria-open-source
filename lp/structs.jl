...
struct ParametrosFormulario
	...
	peso_disciplinas :: Dict{String, Float64}
	peso_numdisc     :: Dict{String, Float64}
	peso_cargahor    :: Dict{String, Float64}
	peso_horario     :: Dict{String, Float64}
	peso_distintas   :: Dict{String, Float64}
	peso_manha_noite :: Dict{String, Float64}
	peso_janelas     :: Dict{String, Float64}
