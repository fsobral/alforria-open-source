...
chprevia1 :: Dict{String, Int64} = Dict{String, Int64}("P1" => 10, "P2" => 0)  # preenchido por preencheFormulario!
chprevia2 :: Dict{String, Int64} = Dict{String, Int64}()  # idem

form = ParametrosFormulario(
    Set(["P2"]),                    # temporario
    chprevia1,          # chprevia1  (zerado → preenchido por preencheFormulario!)
    chprevia2,          # chprevia2
